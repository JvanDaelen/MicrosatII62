function [x,y,z,dx,dy,dz] = closingTrajectory(n,pos_0,dx_ref,dy_ref,pos_t,c)

% The closingTrajectory function uses the CW equations to recompute the
% closing trajectory (position and velocity at each point) given that the
...
fx = 0; fy = 0; fz = 0; % Unperturbed relative motion [N]
