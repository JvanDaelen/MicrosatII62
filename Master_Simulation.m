...
while running
    ...
    if mode == "Final"
        ...
        [relative_state_chaser, absolute_state_chaser, P, alpha, beta, ...
            gamma, station_keeping_points, desired_relative_state, mode] = navigation_vbn5( ...
        ...
        %[relative_state_chaser, absolute_state_chaser, P, alpha, beta, gamma] = navigation_vbn3( ...
         %relative_state_chaser, ...
         %absolute_state_chaser, ...
         %absolute_state_target, ...
         %control_force, ...
    ...
    % Navigation
    % [relative_state_chaser, absolute_state_chaser, P, alpha, beta, gamma] = navigation_vbn2( ...
    %     relative_state_chaser, ...
    %     absolute_state_chaser, ...
    %     absolute_state_target, ...
    %     control_force, ...
